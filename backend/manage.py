...
def add_listings():
    ...
    listing1 = Listing(
        ...
        weight=5.0,
        volume=1.0,
        address="81, Phillip Street, Waterloo, Sydney, Council of the City of Sydney, New South Wales, 2017, Australia",
        latitude=-33.8962466,
        longitude=151.2053577,
    ...
    listing2 = Listing(
        ...
        weight=.5,
        volume=2.0,
        address="Willoughby, Sydney, Willoughby City Council, New South Wales, 2068, Australia Administrative ",
        latitude=-33.8071021,
        longitude=151.1993551,
    ...
    listing4 = Listing(
        ...
        weight=1.0,
        volume=1.0,
        address="Parramatta, Sydney, City of Parramatta Council, New South Wales, 2150, Australia",
        latitude=-33.8139843,
    ...
    listing5 = Listing(
        ...
        can_trade=True,
        status="active",
        address="Rockdale, Sydney, Bayside Council, New South Wales, 2216, Australia Administrative ",
        latitude=-33.9542619,
    ...
    listing6 = Listing(
        ...
        can_trade=True,
        status="active",
        address="Manly, Sydney, Northern Beaches Council, New South Wales, 2095, Australia",
        latitude=-33.7971937,
        longitude=151.2879845,
        categories=["electronics"],
        weight=.2,
        volume=.2,
        materials=["plastic", "metal"],
